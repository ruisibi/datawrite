...
public class RoleController extends BaseController {
	...
	public @ResponseBody
    Object userRolelist(String userId) {
    ...
    Object userRoleSave(@RequestBody Map<String, Object> pms) {
		List<String> roleId = (List<String>)pms.get("roleId");
		String userId = (String) pms.get("userId");
		service.addUserRole(roleId.toArray(new String[roleId.size()]), userId);
