...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filters.put("authc", new SessionAuthcFilter(userService, userUrlControlService, appID));
        //filters.put("shareAuthc", new ShareUrlSessionAuthcFilter(shareUrlService, appID));
