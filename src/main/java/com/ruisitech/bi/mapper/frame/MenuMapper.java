...
public interface MenuMapper {
	...
	List<Menu> listUserMenus(@Param("userId") String userId);
	 ...
	 * @return
	 */
	List<Menu> listRolesMenus(@Param("roleIds") List<String> roleIds);
	...
	List<Map<String, Object>> listMenuByPid(@Param("pid") String pid);
	 ...
	 * @return
	 */
	List<String> listUserVisitUrl(@Param("userId") String userId);
