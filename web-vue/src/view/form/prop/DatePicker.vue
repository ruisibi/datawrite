  ...
  <el-form :model="prop" ref="propForm" label-position="left" size="mini">
    <el-collapse v-model="activeName" accordion>
      <el-collapse-item title="基本信息" name="1" >
          ...
          <el-form-item label="显示类型：" label-width="110px">
          ...
          <el-form-item label="日期格式：" label-width="110px">
             <el-select v-model="prop.fmt" @change="changevalue('fmt')" placeholder="请选择">
                <el-option
                  v-for="item in opts.fmts"
                  :key="item"
                  :label="item"
                  :value="item">
                </el-option>
...
export default {
  ...
  data(){
    return {
      ...
      opts:{
       types:["year","month","date","datetime"],
       fmts: ["yyyy", "yyyyMM", "yyyy-MM", "yyyyMMdd","yyyy-MM-dd","yyyyMMdd HHmmss","yyyy-MM-dd HH:mm:ss"],
      }
    }
  },
  mounted(){
