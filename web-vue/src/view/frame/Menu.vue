		...
		<div class="row">
			<div class="col-sm-6">
				<el-form :model="menu" :rules="rules" ref="menuForm" size="small">
					...
					<el-form-item label="排序" label-width="100px" prop="menuOrder">
				...
				this.$refs['menuForm'].validate((valid) => {
					if (valid) {
						ajax({
							...
							data: ts.menu,
							postJSON:false,
							url:ts.isupdate?"auth/menu/update.action":"auth/menu/save.action",
