...
export const converMapData = (data, geoCoordMap)=>{
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (geoCoord) {
            res.push([geoCoord[0], geoCoord[1], o.value, o.name]);
        }
    }
    return res;
};
